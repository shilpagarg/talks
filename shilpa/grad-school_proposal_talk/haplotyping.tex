...
\only<2>{\includegraphics[width=\textwidth]{figs/haplotyping-overview2}}%
\only<3>{\includegraphics[width=\textwidth]{figs/haplotyping-overview3}}%
\only<4>{\includegraphics[width=\textwidth]{figs/haplotyping-overview4}}%
...
\begin{frame}{Future work}
\begin{itemize}
 \item Port it as graph problem -- overlap graph.
 \item Bubble detection. 
\end{itemize}
	\begin{center}
		\only<1>{\includegraphics[width=\textwidth, height=175]{figs/assembly1}}%
	\end{center}
\end{frame}
...
\end{itemize}
	...
	\begin{center}
		\only<1>{\includegraphics[width=\textwidth, height=175]{figs/assembly2}}%
	\end{center}
\end{frame}

\begin{frame}{Future work}
\begin{itemize}
 \item Perform phasing using PacBio aligned reads over the bubbles.
\end{itemize}

	\begin{center}
		\only<1>{\includegraphics[width=\textwidth, height=175]{figs/assembly3}}%
	\end{center}
\end{frame}
...
% 		\item Phasing is biologically meaningful in detecting the causes of diseases.
